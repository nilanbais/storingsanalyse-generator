...
Functies/methods die geschreven moeten worden, zijn:
    ...
    -   [x] method voor het filteren van meldingen of storingen op een te kiezen di nummer
    -   [ ] method voor het updaten en opslaan van de nieuw gegenereerde metadata
"""
import json
import pandas as pd
import numpy as np
...
class MetadataStoringsAnalyse:
    ...
    def get_di_dict(self, di: str, notification_type: str = 'meldingen') -> dict:
        """
        method to filter the dict provided by self.meldingen() or self.storingen() on a specific di number.
    ...
    def sum_values(self, dictionary: dict, keys: list = None):
        ...
        van de method beter om te stoppen op het hoogste level van keys (stap voordat één antwoord verkregen wordt.
    ...
    def avg_yearly(self, dictionary: dict, exclude_year: Union[List[str], str] = None) -> float:
        """
        method calulates the yearly average number of notifications.
        :param dictionary:
        :param exclude_year:
        :return:
        """
    ...
    def get_keys(self, dictionary: dict,  containing_months: Union[List[str], str] = None, containing_quarter: Union[List[str], str] = None, containing_year: Union[List[str], str] = None) -> list:
        ...
        (Note that this method is the complete opposite of self.get_month_list().
        :param dictionary:
    ...
    # todo: method voor opslaan metadata
