...
#         rel_filepath = "data\\metadata\\" + self.filename
    ...
    def project(self) -> str:
        return self.old_meta["project"][0]
...
#         meta = self.get_all_data()
    ...
    def save_backup_meta(self, path_to_folder: str = "") -> None:
        filename = MetadataStoringsAnalyse._default_file_name_backup_version.format(self.project, self._quarter, self._year)
        with open(os.path.join(path_to_folder, filename), 'w') as backup_file:
            json.dump(self.old_meta, backup_file)
    ...
    def save_meta(self, path_to_meta_folder: str, path_to_meta_backup_folder: str) -> None:
        self.save_backup_meta(path_to_folder=path_to_meta_backup_folder)
        self.save_updated_meta(path_to_folder=path_to_meta_folder)
