...
class StoringsAnalyse:
    ...
    def read_staging_file(self, filename):
        ...
        return "Done. Data available through the use of StoringsAnalyse.staging_file_data"
    ...
    def _isolate_notification_type(self, type_to_iso='storingen'):
        ...
        return self.staging_file_data[self.staging_file_data['type melding (Storing/Incident/Preventief/Onterecht)'].lower() == type_to_iso]
